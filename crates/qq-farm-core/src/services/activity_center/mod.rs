...
pub use crate::constants::{
    CHARITY_PROGRESS_ALREADY_CLAIMED_CODE, CHARITY_RED_FLOWER_ACTIVITY_ID,
    ...
    CONTINUE_QINGMEI_BREW_OPERATE_TYPE, DONATE_CHARITY_LOVE_OPERATE_TYPE,
    ...
    QINGMEI_ITEM_ID, QINGMEI_SHARED_SETTLEMENT_MODE, QINGMEI_SHARE_SCENE, QINGMEI_SHARE_SOURCE,
...
pub struct ActivityCenterService {
    ...
    last_charity_red_flower_state:
        Mutex<HashMap<i64, crate::services::activity_center_state::CharityRedFlowerState>>,
}
...
impl ActivityCenterService {
    ...
    pub fn new(gateway: Arc<Gateway>) -> Self {
        Self {
            ...
            last_charity_red_flower_state: Mutex::new(HashMap::new()),
        }
    }
