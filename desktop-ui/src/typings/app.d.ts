      ...
      page: {
        ...
        farm: {
          ...
          activity: {
            ...
            qixiSachet: string;
            qixiReceived: string;
            qixiSearchFriend: string;
            qixiStageClaimable: string;
            qixiStageDone: string;
            qixiStageCurrent: string;
            qixiInactive: string;
            qixiOpen: string;
            qixiStage: string;
            qixiProgress: string;
            qixiCurrentStage: string;
            qixiSentFriends: string;
            qixiNeed: string;
            qixiSelectFriend: string;
            qixiGiftTo: string;
            qixiMax: string;
            qixiStageLocked: string;
            qixiNoReward: string;
            qixiNoFriend: string;
            qixiAvailable: string;
            qixiFriendFallback: string;
            qixiRules: string;
            viewRules: string;
            rulesEmpty: string;
            qixiGiftSuccess: string;
            tabCharity: string;
            charityLove: string;
            charityDonated: string;
            charitySettlement: string;
            charityEligible: string;
            charityNotYet: string;
            charityGlobalDonated: string;
            charityGlobalProgress: string;
            charityRewardAt: string;
            charitySeedTitle: string;
            charityClaimSeeds: string;
            charitySeedsClaimed: string;
            charityDonateTitle: string;
            charityDonateHint: string;
            charityDonateConfirm: string;
            charityDonateAll: string;
            charityGiftTitle: string;
          ...
          settings: {
            ...
            quietStart: string;
            quietEnd: string;
            quietContinueFarm: string;
            friendAutoAccept: string;
            autoAcceptFriendMinLevel: string;
            autoAcceptMinLevelHint: string;
            autoAcceptRequireOwnLevel: string;
            autoAcceptHarvestStealEnabled: string;
            ...
            mysteryPurchaseNotify: string;
            mysteryAllowGold: string;
            mysteryAllowCoupon: string;
            mysteryAllowGoldBean: string;
            mysteryAllowDiamond: string;
            ...
            provider: string;
            providerNone: string;
            providerQqBot: string;
            providerDingTalk: string;
            providerWechatBot: string;
            dingtalkEndpoint: string;
            dingtalkEndpointPlaceholder: string;
            dingtalkToken: string;
            dingtalkTokenPlaceholder: string;
            dingtalkSecret: string;
            dingtalkSecretPlaceholder: string;
            dingtalkHint: string;
            botDocs: string;
            botDocsOpenFail: string;
            qqBotBindStatus: string;
            qqBotBindUnbound: string;
            qqBotBindWaiting: string;
            qqBotBindBound: string;
            qqBotBindStart: string;
            qqBotBindSuccess: string;
            qqBotBindExpired: string;
            qqBotAppId: string;
            qqBotClientSecret: string;
            qqBotHint: string;
            qqBotBindHint: string;
            qqBotBindScanHint: string;
            qqBotBindManualHint: string;
            qqBotOpenBot: string;
            qqBotUnbind: string;
            qqBotUnbindSuccess: string;
            ...
            network: string;
            userAgent: string;
            saveRuntimeEnv: string;
            resetRuntimeEnv: string;
            saveSystemConfigSuccess: string;
            resetSystemConfigSuccess: string;
            fertilizerCheckFailed: string;
          };
          gameConfig: {
            title: string;
            tabSeeds: string;
